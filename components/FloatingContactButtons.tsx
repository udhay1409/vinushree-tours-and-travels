    ...
    <div className="fixed bottom-6 right-6 flex flex-col gap-4 z-50">
      ...
      <div className="relative">
        <Button
          ...
          className="bg-green-500 hover:bg-green-600 text-white rounded-full w-14 h-14 shadow-2xl hover:scale-110 transition-all duration-300 hover:shadow-green-500/25 animate-bounce hover:animate-none"
          style={{
      ...
      <div className="relative">
        <Button
          ...
          className="bg-blue-500 hover:bg-blue-600 text-white rounded-full w-14 h-14 shadow-2xl hover:scale-110 transition-all duration-300 hover:shadow-blue-500/25"
        >
